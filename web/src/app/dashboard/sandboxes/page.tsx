...
const DEMO_SANDBOXES = [
  {
    ...
    summary: "issue_refund timeout_after_success → 2 refunds (double refund detected)",
    tool: "issue_refund",
    injected_fault: "timeout_after_success",
    timestamp: "2 minutes ago",
    invariants_violated: "refund_calls <= 1",
  },
];
...
const DEMO_SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    hypothesis: "duplicate callback marks refund as complete twice, confusing the agent state",
    initial_state: { customer_verified: true, refund_status: "pending", ledger_refunds: 0 },
    status: "predicted",
  },
];
