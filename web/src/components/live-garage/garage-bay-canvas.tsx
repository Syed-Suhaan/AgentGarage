...
const STATIONS: StationInfo[] = [
  {
    ...
    code: "BAY_01",
    status: "ONLINE",
    description: "Task intake. Dispatched diagnose_vehicle.",
  ...
  },
  {
    ...
    code: "BAY_02",
    status: "PASS",
    description: "OBD-II link verified on Sedan #42.",
  ...
  },
  {
    ...
    code: "BAY_03",
    status: "ACTIVE",
    description: "read_obd polled DTC registers.",
  ...
  },
  {
    ...
    code: "BAY_04",
    status: "FAIL",
    description: "Injected sensor delay. Agent returned the wrong code.",
  ...
  },
  {
    ...
    code: "BAY_00",
    status: "STANDBY",
    description: "3 standby mechanic-bots parked here.",
  ...
  },
  {
    ...
    code: "HAZARD_01",
    status: "WARNING",
    description: "Untested fault condition flagged for sandbox eval.",
  ...
  },
  {
    ...
    code: "GATE_01",
    status: "ACTIVE",
    description: "Checkpoint score 0.12. FAIL against P0420.",
